...
class ExperienceBuffer:
    ...
    def backpropagate(
        ...
        self._action_logprob_collections = \
            policy(self._observation_collections)[0] \
                .log_prob(self._action_collections)

        value_collections = value_function(self._observation_collections)[0]
    ...
    def to_dataset(self) -> TensorDataset:
        dataset = TensorDataset(
            self._observation_collections,
            self._action_collections,
            self._action_logprob_collections,
            self._advantage_collections,
            self._reward_to_go_collections
        )
